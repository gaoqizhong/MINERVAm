...
data_input_dir="datasets/Open-IMG-M/"       # dataset source
vocab_dir="datasets/Open-IMG-M/vocab"       # vocab source
...
base_output_dir="output/OpenBG-IMG-M/"      # output directory for logs and socres
