...
data_input_dir="datasets/OpenBG-IMG-SingleMode/"       # dataset source
vocab_dir="datasets/OpenBG-IMG-SingleMode/vocab"       # vocab source
...
beta=0.02                                   # entropy regularization parameter
...
base_output_dir="output/OpenBG-IMG-SingleMode/"      # output directory for logs and socres
